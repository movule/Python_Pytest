...
class TestingInventoryCreation:
    ...
    def test_creating_specified_inventory(self):
      ...
      assert {'iPhone Model X':100, 'Xiaomi Model Y': 1000, 'Nokia Model Z':25}  == {'iPhone Model X':100, 'Xiaomi Model Y': 1000, 'Nokia Model Z':25}
...
class TestInventoryAddStock:
    ...
    def test_add_new_stock_as_dict(self):
      mi = self.inventory.add_stock({'iPhone Model X':50, 'Xiaomi Model Y': 2000, 'Nokia Model A':10})
      assert {'iPhone Model X':150, 'Xiaomi Model Y': 3000, 'Nokia Model Z':25, 'Nokia Model A':10} == {'iPhone Model X':150, 'Xiaomi Model Y': 3000, 'Nokia Model Z':25, 'Nokia Model A':10}
...
class TestInventorySellStock:
    ...
    def test_sell_stock_as_dict(self):
      mi = self.inventory.sell_stock({'iPhone Model A':2, 'Xiaomi Model B':20, 'Sony Model D':1})
      assert {'iPhone Model A':48, 'Xiaomi Model B': 1980, 'Nokia Model C':10, 'Sony Model D':0} == {'iPhone Model A':48, 'Xiaomi Model B': 1980, 'Nokia Model C':10, 'Sony Model D':0}
